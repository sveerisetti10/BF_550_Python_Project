...
distance_matrix <- read_csv('/Users/sveerisetti/Desktop/Boston_University/Semester2/BF_550_Python/Final_Project/Bee_data/CSV_PCoA_Data/Weighted_PCOA_Data.csv')
